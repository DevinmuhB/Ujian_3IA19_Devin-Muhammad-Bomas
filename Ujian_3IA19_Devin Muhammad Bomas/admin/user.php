...
<header>
    ...
    <marquee style="color:blue"><font size="5">WELCOME NEW USER!</font></marquee>
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-3 text-center">
            ...
            <h2 class="fw-bold mb-2 text-uppercase">Hello User</h2>
              <p class="text-white-50 mb-5">Silahkan Isi Data Dibawah</p>
...
<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary my-5" name="submit">Tambahkan Data</button>
</form>
    </div>
          </div>
        </div>
